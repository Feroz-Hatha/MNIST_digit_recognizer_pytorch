...
from torch.utils.data import DataLoader # data loading utility that allows us to effortlessly build data pipelines to train our CNN
from torchvision.transforms import ToTensor
from torchvision.datasets import MNIST # The MNIST dataset loader built into the PyTorch library
...
(which is the equivalent to training a model with an output Linear layer and an nn.CrossEntropyLoss loss). Basically, 
PyTorch allows you to implement categorical cross-entropy in two separate ways.
'''
